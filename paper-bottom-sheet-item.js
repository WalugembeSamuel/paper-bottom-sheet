...
class PaperBottomSheetItem extends PolymerElement{
    static get is(){return 'paper-bottom-sheet-item';} 
    static get template(){
        return html`
            <style>
                :host {
    ...
    static get properties() {
        return {
            ...
            /**
             * Icon ID for the item. The icon will be passed to [`iron-icon`](https://elements.polymer-project.org/elements/iron-icon). See for [options](https://elements.polymer-project.org/elements/iron-icons?view=demo:demo/index.html&active=iron-icons).
             */
            icon: {
                type: String,
                value: 'icons:check'
...
window.customElements.define(PaperBottomSheetItem.is, PaperBottomSheetItem);